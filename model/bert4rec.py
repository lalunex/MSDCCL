...
class BERT4Rec(SequentialRecommender):
    ...
    def forward(self, item_seq, item_seq_emb):
    ...
    def calculate_loss(self, interaction):
        ...
        seq_output = self.forward(item_seq, self.item_embedding(masked_item_seq))
    ...
    def predict(self, interaction):
        ...
        seq_output = self.forward(item_seq, self.item_embedding(item_seq))
